...
const l_ifc_handle g_lin_hardware_ifc[HARDWARE_INSTANCE_COUNT] = {INVALID_IFC, LI0, INVALID_IFC};//boson
const l_u32 g_lin_virtual_ifc[LIN_NUM_OF_IFCS] = {LIN_UART_PORT};
